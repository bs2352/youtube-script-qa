...
トピックは、1行に1個ずつ、時間順に連番を付与して記載されています。
文字起こしには、[]で囲んで開始時刻が添えられています。
記載された全てのトピックについて開始時刻を取得して、トピックと開始時刻を指定されたフォーマットで出力してください。
開始時刻を取得する時は文字起こしとそれに付与された開始時刻を参考にしてください。
